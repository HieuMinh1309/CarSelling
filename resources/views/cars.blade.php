        ...
        <div class="card">
            <div class="parts-container container" >
                <div class="row" id="myDIV">
                    ...
                    <div class="box col-md-3">
                        <img id="heght" src="{{ asset('/img/civic.jpg') }}" alt="">
                    ...
                    <!-- box2 -->
                    <div class="box col-md-3">
                        <img id="heght" src="{{ asset('/img/audiden.jpg') }}" alt="">
                    ...
                    <!-- box3 -->
                    <div class="box col-md-3">
                        <img id="heght" src="{{ asset('/img/bmw.jpg') }}" alt="">
                    ...
                    <!-- box4 --> 
                    <div class="box col-md-3">
                        <img id="heght" src="{{ asset('/img/Ford-Everest.jpg') }}" alt="">
            ...
            <div class="parts-container container" >
                <div class="row" id="myDIV">
                    <!-- box5 -->
                    <div class="box col-md-3">
                        <img id="heght" src="{{ asset('/img/hyundaiac.jpg') }}" alt="">
                    ...
                    <!-- box6 -->
                    <div class="box col-md-3">
                        <img id="heght" src="{{ asset('/img/toyotacr.jpg') }}" alt="">
                    ...
                    <!-- box7 -->
                    <div class="box col-md-3">
                        <img id="heght" src="{{ asset('/img/nis.jpg') }}" alt="">
                    ...
                    <!-- box8 -->
                    <div class="box col-md-3">
                        <img id="heght" src="{{ asset('/img/po911.jpg') }}" alt="">
            ...
            <div class="parts-container container" >
                <div class="row" id="myDIV">
                    <!-- box9 -->
                    <div class="box col-md-3">
                        <img id="heght" src="{{ asset('/img/suzuki.jpg') }}" alt="">
                    ...
                    <!-- box10 -->
                    <div class="box col-md-3">
                        <img id="heght" src="{{ asset('/img/maz6.jpg') }}" alt="">
