...
<body>
    ...
    <div id="main">
        ...
        <div class="head">
            <div class="col-div-6">
                <span style="font-size:30px;cursor:pointer; color: white;" class="nav">&#9776; Add Logo</span>
                <span style="font-size:30px;cursor:pointer; color: white;" class="nav2">&#9776; Add Logo</span>
            </div>
            <div class="clearfix"></div>
        </div>
        <br/>
        <h1 id="text">Create New Logo</h1>
        <form action="{{ route('uploadLogos.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
