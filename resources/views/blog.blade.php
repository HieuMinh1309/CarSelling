...
<body>
            ...
            <div class="container text-center">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        ...
                        <li class="breadcrumb-item text-danger active" aria-current="page" id="blog">Blog</li>
    ...
    <!-- blog section -->
        <section class="blog" id="blog">
                <span class="carsfont fontt"> B L O G</span>
                <a href="/" class="navbar-brand d-flex align-items-center px-4 px-lg-5 v1">
                    <h2 class="m-0" style="color:#a80000"><i class="fa fa-car me-3"></i> AutoWorld</h2>
                </a>
                <p class="fontt">Auto World is one of the reputable and quality car information <br>
                     and car buying and selling sites in Vietnam. Here, there are experts <br>
                      who share their knowledge about cars and compare vehicles with each other. <br> 
                      There are mid-range to high-end vehicles for you to choose from and compare, <br>
                       and we have advice on car buying on installments. Welcome to Autoworld!!!</p>
        </section>
        <section class="blog" id="news" style="margin-top: 100px;">
            <span class="carsfont fontt"> N E W S</span>
            <!-- blog container -->
            <div class="blog-container container">
                <!-- box 1 -->
                <div class="box">
                    <img src="../img/blog audi.jpg" id="kichco" alt=""> <br>
                 ...
                 <!-- box 2 -->
                 <div class="box">
                    <img src="../img/blogaudi.jpg" id="kichco" alt=""><br>
                    <span>Feb 19 2023</span>
                    <h3>How to Get Perfect Car At Low Price</h3>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo,veniam</p>
                    <a href="#" class="blog-btn">Read More<i class='bx bx-right-arrow-alt'></i></a>
                 ...
                 <!-- box 3 -->
                 <div class="box">
                    <img src="../img/blogaudi1.jpg" id="kichco" alt=""><br>
                    <span>Feb 19 2023</span>
                    <h3>How to Get Perfect Car At Low Price</h3>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo,veniam</p>
                    <a href="#" class="blog-btn">Read More<i class='bx bx-right-arrow-alt'></i></a>
