            ...
            <div class="form-group">
                    <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ $blog->title }}" placeholder="Input for title">
                        </div>
                        <div>
                            <br>
                            <label id="text" for="title">Description:</label>
                            <input type="text" name="description" id="title" placeholder="Input for description">
                        </div>
                        <div>
                            <br>
                            <label id="text" for="content">Content:</label>

                            <textarea placeholder="Input for content" name="content" id="content" cols="30" rows="10">{{ $blog->content }}</textarea>
                        </div>
                    </div>
                </div>            
