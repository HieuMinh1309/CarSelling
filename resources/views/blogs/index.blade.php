	...
	<div class="col-div-8">
		<div class="content-box">
			<div style="display:flex; ">
				<a class="cssbuttons-io-button" href="{{ route('blogs.create') }}">
                ...
                <table id="carTable">
                    ...
                    @foreach ($blogs as $blog)
                        <tr>
                            ...
                            <td><img src="../uploadBlog/{{$blog->imageBlog}}"></td>
                            <td>{{ $blog->title }}</td>
