        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative">
                ...
                <div class="testimonial-item text-center">
                    ...
                    <h5 class="mb-0">Anh Huấn (Rose)</h5>
                    <p>Civic Education Teacher</p>
                    <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0">Tôi là một người có nhu cầu tìm hiểu nhiều loại xe nên trang web này rất thích hợp với những người như tôi, web có nhiều chức năng hay ho, tôi chấm trang web này 9.5đ.</p>
                    </div>
                </div>
                <div class="testimonial-item text-center">
                    <img class="bg-light rounded-circle p-2 mx-auto mb-3" src="{{ asset('img/testimonial-3.jpg') }}" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Anh Tùng (MTP)</h5>
                ...
                <div class="testimonial-item text-center">
                    ...
                    <h5 class="mb-0">Chị Bích Phương</h5>
                    <p>Singer</p>
                    <div class="testimonial-text bg-light text-center p-4">
