	...
	<div class="col-div-8">
		<div class="content-box">
			<div style="display:flex; ">
				<a class="cssbuttons-io-button" href="{{ route('contact.create') }}">
